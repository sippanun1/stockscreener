...
export default function SummaryInfo({ stocks }: SummaryInfoProps) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8 pl-[53px] pr-[53px]">
      {/* Total Stocks */}
      <div className="flex items-center gap-10 bg-[#7588A31A] rounded-lg p-6 border border-[#7588A3]/20 w-[320px] h-[95px] pl-10">
        <div>
      ...
      <div className="flex items-center gap-10 bg-[#7588A31A] rounded-lg p-6 border border-[#7588A3]/20 w-[320px] h-[95px] pl-10">
        ...
        <div className="flex items-center justify-between bg-[#7588A31A] rounded-lg p-6 border border-[#7588A3]/20 w-[320px] h-[95px]">
        <div>
